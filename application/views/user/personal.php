...
$(document).ready(function(){
    ...
    function loadtable(){
        taskDataTable = $('#taskTable').DataTable( {
            "pageLength": 10,
            "ajax": "<?php echo base_url()?>user/personal/view_task",
            "columns": [
                { data: "id"},
    ...
    function refresh(){
        var url = "<?php echo base_url()?>user/personal/view_task";
...
// Create task
        ...
        var taskDueDate = new Date(taskDueDate);
                ...
                if(taskDescription == '' || taskCategory == '' || taskDueDate == ''){
                    ...
                    // ajax call
                        ...
                        // ajax post
                        $.ajax({
                            url: '<?php echo base_url()?>user/personal/add_task',
                            type: 'post',
                            data: form.serialize(),
    ...
    $(document).on("click", ".btn_update", function(){
        ...
        $.ajax({
            url: '<?php echo base_url()?>user/personal/get_task/'+id,
            type: "GET",
            dataType: "JSON",
    ...
    $('#editTaskForm').on('submit', function(e){
                        ...
                        // Ajax call
                            $.ajax({
                                url: '<?php echo base_url()?>user/personal/update_task',
                                type: 'post',
                                data: form,
    ...
    $(document).on("click", ".btn_delete", function(){
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                // Ajax call
                    $.ajax({
                            url: '<?php echo base_url()?>user/personal/delete_task',
                            data: {id: id},
                                success:function(){
                                    refresh()
                                }
    ...
    $(document).on("change", "#taskComplete", function(){
        ...
        // Ajax call
            $.ajax({
                url: '<?php echo base_url()?>user/personal/complete_task',
                data: {id: id},
                    success:function(){
                        refresh()
                    }
    ...
    $(document).on("change", "#taskUncomplete", function(){
        ...
        // Ajax call
            $.ajax({
                url: '<?php echo base_url()?>user/personal/uncomplete_task',
                data: {id: id},
                    success:function(){
                        refresh()
                    }
